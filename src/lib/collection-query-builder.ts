...
export const collectionQueryBuilder = (
  ...
  if (request?.datePreference !== undefined) {
    params?.set("datePreference", request.datePreference.toString());
  }
  if (request?.averageRate !== undefined) {
    params?.set("averageRate", request.averageRate.toString());
  }
  if (request?.categoryId !== undefined) {
    params?.set("categoryId", request.categoryId.toString());
  }
  if (request?.routeId !== undefined) {
    params?.set("routeId", request.routeId.toString());
  }
